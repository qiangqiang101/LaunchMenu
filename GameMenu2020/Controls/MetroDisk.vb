...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        If _Theme = True Then
            ...
            _BorderColor = Color.FromArgb(47, 49, 54)
            _BorderColor = Color.FromArgb(47, 49, 54)
        Else
            'dark
            _HeaderColor = Color.FromArgb(47, 49, 54)
            _BaseColor = Color.FromArgb(47, 49, 54)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            GP = MetroDisk.RoundRec(Base, _Curve)
            ...
            If _Arrows Then
                '-- Arrows
                GP2 = MetroDisk.DrawArrow(28, 2, False)
                .FillPath(New SolidBrush(_BaseColor), GP2)
                GP3 = MetroDisk.DrawArrow(28, 8, True)
                If _LightTheme Then
        ...
        With G
            ...
            Select Case O
                Case _Options.Style1   '-- Style 1
                    '-- Base
                    GP = MetroDisk.RoundRec(Base, 6)
                    GP2 = MetroDisk.RoundRec(Toggle, 6)
                    ...
                    If Checked Then
                        '-- Base
                        GP = MetroDisk.RoundRec(Base, 6)
                        GP2 = MetroDisk.RoundRec(New Rectangle(CInt(W \ 2), 0, 38, H), 6)
                ...
                Case _Options.Style2   '-- Style 2
                    ...
                    GP2 = MetroDisk.RoundRec(Toggle, 4)
...
#Region " TextBox Properties"
    ...
    Public ReadOnly Property IsFocused() As Boolean
        ...
        End Get
    End Property
    Public Property EnterPressed() As Boolean
        Get
    ...
    Private _enterPressed As Boolean = False
    ...
    Private Sub OnBaseKeyUp(ByVal s As Object, ByVal e As KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            _enterPressed = False
        End If
    End Sub
    ...
    Private Sub OnBaseGotFocus(sender As Object, e As EventArgs)
        If TB.Text = _PlaceHolder Then TB.Clear()
        _focused = True
    End Sub

    Private Sub OnBaseLostFocus(sender As Object, e As EventArgs)
        If TB.Text = Nothing Then TB.Text = _PlaceHolder
        _focused = False
    End Sub
    ...
    Private _rightImagesize As Size = New Size(17, 17)
...
#End Region
    ...
    Sub New()
        If _Theme = True Then
            ...
            _TextColor = Color.FromArgb(47, 49, 54)
            ...
            AddHandler TB.KeyUp, AddressOf OnBaseKeyUp
            AddHandler TB.GotFocus, AddressOf OnBaseGotFocus
            AddHandler TB.LostFocus, AddressOf OnBaseLostFocus
        Else
            _BaseColor = Color.FromArgb(47, 49, 54)
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If _Theme = True Then
            ...
            _FlatColor = Color.FromArgb(47, 49, 54)
            B = New Bitmap(Width, Height) : G = Graphics.FromImage(B)
            W = Width - 1 : H = Height - 1
        ...
        Else
            ...
            With G
                ...
                DrawRoundedRectangle(G, Base, 10, New Pen(Color.FromArgb(54, 57, 63)))
                ...
                '-- Base
                '.FillRectangle(New SolidBrush(_BaseColor), Base)
                FillRoundedRectangle(G, Base, 10, New SolidBrush(_BaseColor))

                '.DrawRectangle(New Pen(Color.FromArgb(54, 57, 63)), New Rectangle(0, 0, W, H))

                If Not _rightImage Is Nothing Then
                    .InterpolationMode = InterpolationMode.HighQualityBilinear
                    Dim rect As New Rectangle(Width - _rightImagesize.Width - 6, 6, _rightImagesize.Width, _rightImagesize.Height)
                    .DrawImage(_rightImage, rect)
                End If
            End With
    ...
    Private Sub FillRoundedRectangle(ByVal g As Drawing.Graphics, ByVal r As Rectangle, ByVal d As Integer, ByVal b As Brush)
...
#Region " Colors"
    ...
    Private BGColor As Color = Color.FromArgb(47, 49, 54)
    Private _BaseColor As Color = Color.FromArgb(54, 57, 63)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Else
            ...
            _BaseColor = Color.FromArgb(54, 57, 63)
        ...
        With G
            ...
            For i = 0 To TabCount - 1
                ...
                If i = SelectedIndex Then
                    ...
                    '-- Gradiant
                    '.fill
                    .FillRectangle(New SolidBrush(Color.FromArgb(66, 70, 77)), BaseSize)
                    ...
                    Else
                        ...
                        .DrawString(TabPages(i).Text, Font, New SolidBrush(unactive), BaseSize, New StringFormat With {.LineAlignment = StringAlignment.Near, .Alignment = StringAlignment.Near})
                    End If
                Else
                    '-- Base
                    .FillRectangle(New SolidBrush(_BaseColor), BaseSize)
                    ...
                    If ImageList IsNot Nothing Then
                        Try
                            If ImageList.Images(TabPages(i).ImageIndex) IsNot Nothing Then
                                ...
                                .DrawImage(ImageList.Images(TabPages(i).ImageIndex), New Point(BaseSize.Location.X + 8, BaseSize.Location.Y + 6))
                                '-- Text
                                .DrawString("      " & TabPages(i).Text, Font, New SolidBrush(Color.White), BaseSize, New StringFormat With {.LineAlignment = StringAlignment.Near, .Alignment = StringAlignment.Near})
                            Else
                                '-- Text
                                .DrawString(TabPages(i).Text, Font, New SolidBrush(active), BaseSize, New StringFormat With {.LineAlignment = StringAlignment.Near, .Alignment = StringAlignment.Near})
                            End If
                        Catch ex As Exception
                            Throw New Exception(ex.Message)
                        End Try
        ...
        With G
            ...
            Select Case Value
                ...
                Case Else
                    ...
                    'GP2 = MetroDisk.RoundRec(Balloon, 4)
                    '.FillPath(New SolidBrush(_BaseColor), GP2)

                    '-- Arrow
                    ''GP3 = MetroDisk.DrawArrow(iValue - 9, 16, True)
...
Class MDComboBox : Inherits ComboBox
...
#End Region
    ...
    Sub DrawItem_(ByVal sender As System.Object, ByVal e As DrawItemEventArgs) Handles Me.DrawItem
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Dim RoundedBase = MetroDisk.RoundRect(0, 0, W, H, , Not (GCS(2) Or GCS(1)), Not (GCS(1) Or GCS(0)), Not (GCS(3) Or GCS(0)), Not (GCS(3) Or GCS(2)))
        Dim Base As New Rectangle(0, 0, W, H)
...
#End Region
    ...
    Sub New()
        If _LightTheme Then
            ...
            ForeColor = Color.FromArgb(47, 49, 54)
            _SelectedColor = Color.FromArgb(200, 200, 200)
        Else
            BaseColor = Color.FromArgb(47, 49, 54)
...
#Region " Colors"
        ...
        Private CheckedColor As Color = Color.Black '_FlatColor
...
#End Region
    ...
    Private Sub Metro_MouseDown(ByVal sender As Object, ByVal e As MouseEventArgs) Handles Me.MouseDown
    ...
    Private Sub Metro_MouseUp(ByVal sender As Object, ByVal e As MouseEventArgs) Handles Me.MouseUp
        Me.BackColor = _MDColor_hover
    End Sub

End Class

Class MDlblButton : Inherits Label
