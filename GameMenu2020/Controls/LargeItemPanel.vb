    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Select Case _imgLayout
            ...
            Case ImageLayout.Stretch
                formGraphics.DrawImage(_image, New RectangleF(10, 10, Width - 20, Height - 20))
            Case ImageLayout.Center
                tbrush.WrapMode = WrapMode.Clamp
                Dim displayArea As New Rectangle(10, 10, Width - 20, Height - 20)
            ...
            Case ImageLayout.Zoom
                ...
                Dim maxHeight As Integer = Height - 20
