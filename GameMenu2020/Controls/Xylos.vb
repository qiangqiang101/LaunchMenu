...
Public Class XylosTabControl
    ...
    Protected Overrides Sub OnControlAdded(e As ControlEventArgs)
        ...
        e.Control.BackColor = Color.FromArgb(47, 49, 54) 'Color.White
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Background As New SolidBrush(ColorFromHex("#F3F4F7")), Border As New Pen(ColorFromHex("#D0D5D9")), TextColor As New SolidBrush(ColorFromHex("#7C858E")), TextFont As New Font("Segoe UI", 9)
                G.FillPath(Background, Xylos.RoundRect(New Rectangle(0, 0, 16, 16), 3))
                G.DrawPath(Border, Xylos.RoundRect(New Rectangle(0, 0, 16, 16), 3))
...
Public Class XylosNotice
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Background As New SolidBrush(ColorFromHex("#FFFDE8")), MainBorder As New Pen(ColorFromHex("#F2F3F7")), TextColor As New SolidBrush(ColorFromHex("#B9B595")), TextFont As New Font("Segoe UI", 9)
            G.FillPath(Background, Xylos.RoundRect(FullRectangle(Size, True), 3))
            G.DrawPath(MainBorder, Xylos.RoundRect(FullRectangle(Size, True), 3))
        ...
        If Enabled Then
            ...
            If State = MouseState.Down Then
                ...
                Using Border As New Pen(ColorFromHex("#78B7E6"))
                    G.DrawPath(Border, Xylos.RoundRect(FullRectangle(Size, True), 12))
                End Using
...
#Region " Drawing "
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Border As New Pen(ColorFromHex("#D0D5D9"))
            G.DrawPath(Border, Xylos.RoundRect(FullRectangle(Size, True), 6))
        End Using

        If Not Value = 0 Then

            Using Background As New Drawing2D.HatchBrush(Drawing2D.HatchStyle.LightUpwardDiagonal, Stripes, BackgroundColor)
                G.FillPath(Background, Xylos.RoundRect(New Rectangle(0, 0, Value / Maximum * Width - 1, Height - 1), 6))
            End Using
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using ButtonFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#C3C3C3"))
                G.DrawPath(Border, Xylos.RoundRect(FullRectangle(Size, True), 3))
