...
Public Class WideItemPanel
    ...
    Private _buttonText As String = "Play"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Dim gBrush As New LinearGradientBrush(New Point(0, 0), New Point(Width, 0), clr1, clr2)
        ...
        Select Case _imgLayout
            Case ImageLayout.Tile
                ...
                formGraphics.FillRectangle(tbrush, New RectangleF(5, 5, Height - 10, Height - 10))
            Case ImageLayout.Stretch
                formGraphics.DrawImage(_image, New RectangleF(5, 5, Height - 10, Height - 10))
            Case ImageLayout.Center
                tbrush.WrapMode = WrapMode.Clamp
                Dim displayArea As New Rectangle(5, 5, Height - 10, Height - 10)
            ...
            Case ImageLayout.Zoom
                ...
                Dim maxWidth As Integer = Height - 10
                Dim maxHeight As Integer = Height - 10
                ...
                formGraphics.DrawImage(_image, New RectangleF(5, 5, newWidth, newHeight))
        End Select
        ...
        If _mouseEnter Then
            DrawRoundedRectangle(formGraphics, New Rectangle(80, 20, Width / 2 + 30, 40), 20, New Pen(BackColor))
            FillRoundedRectangle(formGraphics, New Rectangle(80, 20, Width / 2 + 30, 40), 20, New SolidBrush(btnclr))
            ...
            Using f As Font = New Font(Font.Name, Font.Size, Font.Style, GraphicsUnit.Point)
                Dim rect As New Rectangle(80, 5, Width / 2 + 30, Height - 5)
