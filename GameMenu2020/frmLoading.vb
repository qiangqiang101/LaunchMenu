...
#End Region
    ...
    Dim memeList As New List(Of String) From {"[A MEME]", "Suh dud", "PK Load Ω", "Generating terrain...", "Ready Player One", "Did they just walk up slowly and load?",
        "I solemnly sewar that i am up to no good", "Loading Lines in 2020 LUL", "Switching Sides", "Dispatching carrier pigions", "Is this thing on..?", "Error 404: Joke Not Found",
        "We at pumpkin hill, you ready?", "Preparing Final Form", "ULTIMATE IS READY!", "Activating Witch Time...", "Insert Coin to Continue", "Spinning to Win", "Entering Cheat Codes",
        "Rushing B", "Pressing random buttons", "Cheat Code Activated", "Resetting Run", "Removing pen from pineapple", "Caution: Contents spicy", "Good News Everyone", "Resurrecting dead memes",
        "Clicking circles (to the beat!)", "Building Lore", "We don't Need a healer for this, right?", "Wubba Lubba Dub Dub", "Scaling Bananas", "l o a d i n g a e s t h e t i c s",
        "Procedurally generating buttons", "TRYING TO SKIP A CUTSCENE"}

    Private Function GetMemes() As String
        Dim r As New Random
        Dim id = r.Next(0, memeList.Count)
        Return memeList.Item(id)
    End Function

    Private Sub frmLoading_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblMemes.Text = GetMemes()
    End Sub
    ...
    Public Sub Translate()
        ...
        lblLoading.Text = ReadIniValue(iniFile, "MENU", "Loading")
    End Sub
End Class