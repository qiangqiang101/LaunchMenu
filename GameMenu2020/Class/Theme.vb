...
'            Dim SB As Rectangle = Screen.FromControl(Me).Bounds 'Screen.PrimaryScreen.Bounds
...
'            If e.X > a And e.X < Xstop(index) And e.Y < height And e.Button = System.Windows.Forms.MouseButtons.Left Then
'                SelectedIndex = index
'                Invalidate()
'            Else
'            End If
...
'        G.FillRectangle(Brushes.Black, New Rectangle(New Point(0, 4), New Size(Width - 2, ItemSize.Height - 2)))
...
'        If MouseButtons = System.Windows.Forms.MouseButtons.None And X > Width - 25 Then
'            G.FillRectangle(New SolidBrush(Color.FromArgb(7, Color.White)), Width - 25, 1, Width - 25, Height - 3)
'        ElseIf MouseButtons = system.Windows.Forms.MouseButtons.None And X < Width - 25 And X >= 0 Then
...
'                Dim rect = Screen.FromControl(Me).Bounds
'                Dim height = rect.Height - My.Computer.Screen.WorkingArea.Height
'                FindForm.MaximumSize = New Size(rect.Width, rect.Height - height)
...
'    Private _ActiveColor As Color = Color.FromArgb(35, 168, 109)
